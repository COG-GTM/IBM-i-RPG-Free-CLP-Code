...
Any failure ends the program with an escape message (CPF9898) describing the problem, instead of letting a partly built object name reach RTVOBJD and the API.
